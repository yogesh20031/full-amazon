...
const cart = {
  cartItem,
  //short hand method for the down line code = loadTheCartFromLocalStorage(){}
  lodeTheCartFromLocalStorage: function () {
    this.cartItem = JSON.parse(localStorage.getItem("oop-cart"));
    if (!this.cartItem) {
      this.cartItem = [
        {
...
cart.lodeTheCartFromLocalStorage();
